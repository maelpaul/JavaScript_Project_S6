...
})({"5FCVB":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cc5c31ccf379db3d";
...
},{}],"jMP0a":[function(require,module,exports) {
 ...
 * @param {array of stacks} program A sequence of instructions
 * @param {object} puzzle A puzzle
 * @returns A boolean (true if the execution is correct, throws an error otherwise)
 */ function evaluator(program, puzzle1) {
    let achievementAcquired1 = {
        stars: 0
    };
    function isDone(achievementAcquired) {
        if (puzzle1.achievementRequired.stars === achievementAcquired.stars) return true;
        return false;
    }
    function update(robotRow, robotCol, puzzle, achievementAcquired) {
        if (puzzle.board[robotRow][robotCol][1] === "s") achievementAcquired.stars = achievementAcquired.stars + 1;
        return achievementAcquired;
    }
    function evalRec(robotRow, robotCol, robotDir, instructCount, functionCount, stack, achievementAcquired) {
        if (isDone(achievementAcquired)) return true;
        if (Stack.isEmpty(stack)) throw Error("Puzzle unsolved");
        ...
        if (typeof top === "function") {
            let newcoords = top(robotRow, robotCol, robotDir, puzzle1.board); // <function> top might throw "Out of ground error"
            return evalRec(newcoords[0], newcoords[1], newcoords[2], instructCount + 1, functionCount, Stack.pop(stack), update(newcoords[0], newcoords[1], puzzle1, achievementAcquired));
        } else if (typeof top === "number" && top > 0 && top <= MAXFUNCTIONINPROGRAM) return evalRec(robotRow, robotCol, robotDir, instructCount + 1, functionCount + 1, Stack.append(program[top - 1], Stack.pop(stack)), update(robotRow, robotCol, puzzle1, achievementAcquired));
        else throw Error("Unknown instruction error");
    }
    return evalRec(puzzle1.robotRowInit, puzzle1.robotColInit, puzzle1.robotDirInit, 0, 0, program[0], achievementAcquired1);
}
exports.eval = evaluator;

},{"./stack.js":"eOnbm"}],"eOnbm":[function(require,module,exports) {
...
exports.createEmpty = stackCreateEmpty;
exports.isEmpty = stackIsEmpty;
exports.push = stackPush;
exports.pop = stackPop;
exports.peek = stackPeek;
exports.display = stackDisplay;
exports.append = stackAppend;

},{"./list.js":"7BxUD"}],"7BxUD":[function(require,module,exports) {
...
exports.disp = listDisp;
exports.nil = nil;

},{}]},["5FCVB","jMP0a"], "jMP0a", "parcelRequire94c2")

//# sourceMappingURL=robot.f379db3d.js.map
