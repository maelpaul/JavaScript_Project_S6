...
})({"6wuSS":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "455e3605f6c838e9";
...
},{}],"2YSaq":[function(require,module,exports) {
 ...
 */ function evaluator(program1, programName, aBoardID, puzzle1) {
    ...
    async function evalRec(robot, instructCount, functionCount, callStack, achievementAcquired, debug) {
        ...
        displayCallStack(callStack, program1, programName);
        ...
        if (puzzle1.board[robot.row][robot.col].obstacle.substring(0, 7) === "jumppad") {
            ...
            return evalRec(newCoords, instructCount, functionCount, callStack, update(newCoords, puzzle1, achievementAcquired), debug);
        ...
        if (currentFunction.instruction === program1[currentFunction.function - 1].length) return evalRec(robot, instructCount, functionCount, _stackJs.stackPop(Object.assign({}, callStack)), update(robot, puzzle1, achievementAcquired), _stackJs.stackPop(debug));
            ...
            }, newStack), update(newCoords, puzzle1, achievementAcquired), _stackJs.stackPush(String(currentFunction.function) + String(currentFunction.instruction + 1), _stackJs.stackPop(debug)));
        } else if (typeof currentInstruction === "object" && currentInstruction.number > 0 && currentInstruction.number <= MAXFUNCTIONINPROGRAM) {
            const newStack = _stackJs.stackPop(Object.assign({}, callStack));
            if (currentInstruction.color === puzzle1.board[robot.row][robot.col].color || currentInstruction.color === "") return evalRec(robot, instructCount + 1, functionCount + 1, addInstructionFromOldFunction(currentFunction, currentInstruction, currentFunction.function, currentFunction.instruction, newStack, program1), achievementAcquired, addDebug(currentFunction, currentInstruction, currentFunction.function, currentFunction.instruction, _stackJs.stackPop(debug), program1));
            else {
                if (_stackJs.stackIsEmpty(newStack) && program1[currentFunction.function - 1][currentFunction.instruction + 1] === undefined) throw Error("End of function");
                else return evalRec(robot, instructCount, functionCount, _stackJs.stackPush({
                    "function": _stackJs.stackPeek(callStack).function,
                    "instruction": _stackJs.stackPeek(callStack).instruction + 1
                }, newStack), achievementAcquired, _stackJs.stackPush(String(currentFunction.function) + String(currentFunction.instruction + 1), _stackJs.stackPop(debug)));
            }
    ...
    return evalRec(puzzle1.robotInit, 0, 0, _stackJs.stackPush({
        "function": 1,
        "instruction": 0
    }, _stackJs.stackCreateEmpty()), achievementAcquired1, _stackJs.stackPush("10", _stackJs.stackCreateEmpty()));
}
/**
 ...
 */ function displayCallStack(s1, program, programName) {
    function displayElement(s, i) {
        if (!_stackJs.stackIsEmpty(s)) {
            changeNameInstructionStack(i, getContentFromStackElement(_stackJs.stackPeek(s), program, programName));
 ...
 */ function getContentFromStackElement(element, program, programName) {
    ...
    else return programName[element.function - 1][element.instruction];
}
/**
 ...
 */ function getPuzzleChoice() {
    if (document.getElementById('demo').checked === true) return "demo";
    else return "learningStack";
}
/**
 * 
 ...
 */ async function display(programs, programsName, aBoardID, puzzles1) {
    try {
        const resultEval = await evaluator(programs[getPuzzleChoice()], programsName[getPuzzleChoice()], aBoardID, puzzles1[getPuzzleChoice()]);
...
window.onload = ()=>{
    ...
    const programNameLearningStack = [
        [
            ...function1_name
        ],
        [
    ...
    const programs = {
        "demo": programDemo,
        "learningStack": programLearningStack
    };
    const programsName = {
        "demo": programNameDemo,
        "learningStack": programNameLearningStack
    };
    addRobot(aBoardID, puzzles.demo.robotInit);
    document.getElementById("button_move").addEventListener("click", ()=>display(programs, programsName, aBoardID, puzzles)
    );
    document.getElementById("button_generate_map").addEventListener("click", ()=>generateMap(aBoardID)
    );
};

},{"../src/language.js":"5iD5a","../src/stack.js":"4pwLA","../src/generatePuzzle.js":"bh4V1"}],"4pwLA":[function(require,module,exports) {
...
},{"./list.js":"6igKe","@parcel/transformer-js/src/esmodule-helpers.js":"20LXr"}],"6igKe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"20LXr"}],"bh4V1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ function generateSolvablePuzzle(program1, programColor, puzzle1) {
    ...
    function evalRec(robot, instructCount, functionCount, callStack, achievementAcquired, debug, board) {
        ...
        if (puzzle1.board[robot.row][robot.col].obstacle.substring(0, 7) === "jumppad") {
            const newCoords = jumppad(robot, puzzle1.board[robot.row][robot.col].obstacle);
            return evalRec(newCoords, instructCount, functionCount, callStack, update(newCoords, puzzle1, achievementAcquired), debug, updateBoard(board, robot, "", "", currentFunction));
        } else if (puzzle1.board[robot.row][robot.col].obstacle === "spike" && instructCount % 2 === 0) throw Error("Robot was pricked to death");
        const currentFunction = _stackJs.stackPeek(callStack);
        const currentInstruction = program1[currentFunction.function - 1][currentFunction.instruction];
        if (currentFunction.instruction === program1[currentFunction.function - 1].length - 1) return evalRec(robot, instructCount, functionCount, _stackJs.stackPop(Object.assign({}, callStack)), update(robot, puzzle1, achievementAcquired), _stackJs.stackPop(debug), updateBoard(board, robot, "", "", currentFunction));
        else if (typeof currentInstruction === "function") try {
            const newCoords = currentInstruction(robot, board); // <function> might throw "Out of ground error"
            const newStack = _stackJs.stackPop(Object.assign({}, callStack));
            return evalRec(newCoords, instructCount + 1, functionCount, _stackJs.stackPush({
                "function": _stackJs.stackPeek(callStack).function,
                "instruction": _stackJs.stackPeek(callStack).instruction + 1
            }, newStack), update(newCoords, puzzle1, achievementAcquired), _stackJs.stackPush(String(currentFunction.function) + String(currentFunction.instruction + 1), _stackJs.stackPop(debug)), updateBoard(board, robot, "", "", currentFunction));
        } catch  {
            return {
                "robotInit": puzzle1.robotInit,
                "board": addLastAchievement(board, robot, "star"),
            ...
            if (currentInstruction.color === puzzle1.board[robot.row][robot.col].color || currentInstruction.color === "") return evalRec(robot, instructCount + 1, functionCount + 1, addInstructionFromOldFunction(currentFunction, currentInstruction, currentFunction.function, currentFunction.instruction, newStack, program1), achievementAcquired, addDebug(currentFunction, currentInstruction, currentFunction.function, currentFunction.instruction, _stackJs.stackPop(debug), program1), updateBoard(board, robot, "", "", currentFunction));
                ...
                if (_stackJs.stackIsEmpty(newStack) && program1[currentFunction.function - 1][currentFunction.instruction + 1] === undefined) throw Error("End of function");
                    ...
                    "function": _stackJs.stackPeek(callStack).function,
                    "instruction": _stackJs.stackPeek(callStack).instruction + 1
                }, newStack), achievementAcquired, _stackJs.stackPush(String(currentFunction.function) + String(currentFunction.instruction + 1), _stackJs.stackPop(debug)), updateBoard(board, robot, "", "", currentFunction));
            }
        } else throw Error("Unknown instruction error");
    }
    return evalRec(puzzle1.robotInit, 0, 0, _stackJs.stackPush({
        "function": 1,
        "instruction": 0
    }, _stackJs.stackCreateEmpty()), achievementAcquired1, _stackJs.stackPush("10", _stackJs.stackCreateEmpty()), puzzle1.board);
}

},{"./language.js":"5iD5a","./stack.js":"4pwLA","@parcel/transformer-js/src/esmodule-helpers.js":"20LXr"}]},["6wuSS","2YSaq"], "2YSaq", "parcelRequire94c2")

//# sourceMappingURL=robot.f6c838e9.js.map
