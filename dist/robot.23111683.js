...
})({"ijp4s":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6267c91823111683";
...
},{}],"cr7w1":[function(require,module,exports) {
 ...
 */ function teleport_from_start_to_end(robot, position_final, color, board) {
    console.log(robot);
    if (position_final.row < 0 || position_final.row >= 12 || position_final.col < 0 || position_final.col >= 16) throw new Error("Out of board error");
    else {
        if (color === board[robot.row][robot.col].color || color === "") {
            if (board[position_final.row][position_final.col].color === "black") throw new Error("Out of ground error");
            else return {
                "row": position_final.row,
                "col": position_final.col,
                "dir": robot.dir
            };
        } else return {
            "row": robot.row,
 ...
 */ function teleport(robot, color, distance, board) {
    console.log("on est dans teleport");
    console.log(board === undefined);
    switch(robot.dir){
        case 0:
            return teleport_from_start_to_end(robot, {
                "row": robot.row,
                "col": robot.col + distance
            }, color, board);
        case 1:
            return teleport_from_start_to_end(robot, {
                "row": robot.row - distance,
                "col": robot.col
            }, color, board);
        case 2:
            return teleport_from_start_to_end(robot, {
 ...
 */ function rotateLeft(robot, color, board) {
    if (color === board[robot.row][robot.col].color || color === "") return {
        "row": robot.row,
        "col": robot.col,
        "dir": (robot.dir + 1) % 4
    };
...
// function objectiveStars(collected, expected) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"brgGt"}],"brgGt":[function(require,module,exports) {
...
},{}]},["ijp4s","cr7w1"], "cr7w1", "parcelRequire94c2")

//# sourceMappingURL=robot.23111683.js.map
